...
class ConnectedThread(private val mmSocket: BluetoothSocket, private val mHandler: Handler) :
    ...
    init {
        ...
        Log.e("OutpotData",mmInStream.toString())
        Log.e("tmpOut",mmOutStream.toString())
    }
        ...
        while (true) {
            try {
                ...
                if (bytes != 0) {
                    ...
                    mHandler.obtainMessage(Bluetooth.MESSAGE_READ, bytes, -1, buffer).sendToTarget() // Send the obtained bytes to the UI activity
